...
import com.wljz.utils.Utils;
import com.wljz.utils.HttpConnection.HttpMethod;
...
public class WeChatCore {
	...
	public void flush_access_token() {
		...
		HttpConnection conn = new HttpConnection(HttpType.https, HttpMethod.GET);
	...
	public static String createMenu(String menuJson) {
		...
		HttpConnection conn = new HttpConnection(HttpType.https, HttpMethod.POST);
